...
router
  .route("/admin/orders")
  .get(isAuthenticatedUesr, authorizeRoles("admin"), getAllOrders);

router
  .route("/admin/order/:id")
  .put(isAuthenticatedUesr, authorizeRoles("admin"), updateOrder)
  .delete(isAuthenticatedUesr, authorizeRoles("admin"), deleteOrder);
